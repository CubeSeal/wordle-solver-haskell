...
/* package WordleSolver-0.1.0.0 */
#ifndef VERSION_WordleSolver
#define VERSION_WordleSolver "0.1.0.0"
#endif /* VERSION_WordleSolver */
#ifndef MIN_VERSION_WordleSolver
#define MIN_VERSION_WordleSolver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_WordleSolver */
...
#define CURRENT_COMPONENT_ID "WordleSolver-0.1.0.0-inplace-WordleGuesser"
